...
const studentNotes = (students) => students.map((student) => {
  return {
    name: student.name,
    course: student.courses.reduce((acc, arr) => acc.grade > arr.grade ? acc : arr).name
  }
})


console.log(studentNotes(students));